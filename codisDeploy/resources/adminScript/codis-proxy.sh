...
CODIS_PROXY_PID_FILE=$CODIS_LOG_DIR/codis-proxy.pid

CODIS_PROXY_LOG_FILE=$CODIS_LOG_DIR/codis-proxy.log
CODIS_PROXY_DAEMON_FILE=$CODIS_LOG_DIR/codis-proxy.out

CODIS_PROXY_CONF_FILE=$CODIS_CONF_DIR/proxy.conf

#CODIS_DASHBOARD_ADDR="192.168.1.207:18080"
...
start)
    ...
    nohup "$CODIS_PROXY_BIN" "--config=${CODIS_PROXY_CONF_FILE}" \
    ...
    ;;
start-foreground)
    $CODIS_PROXY_BIN "--config=${CODIS_PROXY_CONF_FILE}"  \
