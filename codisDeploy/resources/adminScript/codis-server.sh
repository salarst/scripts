...
CODIS_SERVER_PID_FILE=$CODIS_LOG_DIR/redis-PORT.pid

CODIS_SERVER_LOG_FILE=$CODIS_LOG_DIR/redis-PORT.log
CODIS_SERVER_DAEMON_FILE=$CODIS_LOG_DIR/codis-server-PORT.out
